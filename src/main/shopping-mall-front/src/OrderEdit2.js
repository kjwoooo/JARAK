...
import './OrderEdit2.css';

function OrderEdit2({ orderId, initialData }) {
    ...
    return (
        <Container className="orderEdit2-container">
            <h1 className="orderEdit2-title">배송 정보 수정</h1>
            <Form className="orderEdit2-form">
                <Form.Group controlId="formRecipientName">
                    ...
                    <Form.Control
                        ...
                        className="orderEdit2-form-control"
                    />
                </Form.Group>
                ...
                <Form.Group controlId="formZipcode">
                    ...
                    <div className="orderEdit2-d-flex">
                        <Form.Control
                            type="text"
                            name="zipcode"
                            ...
                            className="orderEdit2-form-control"
                        />
                        <Button variant="secondary" onClick={handlePostcode} className="orderEdit2-button-secondary">주소찾기</Button>
                    </div>
                </Form.Group>
                ...
                <div className="orderEdit2-buttons">
                    <Button variant="secondary" onClick={() => navigate(-1)} className="orderEdit2-button-secondary">취소</Button>
                    <Button variant="primary" onClick={handleSubmit} className="orderEdit2-button-primary">수정하기</Button>
                </div>
            </Form>
        </Container>
    );
